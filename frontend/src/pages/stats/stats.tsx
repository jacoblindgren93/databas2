...
const salesData = {
    ...
    Carbonara: {
        latest7Days: [120, 130, 140, 160, 150, 170, 180],
        latestMonth: [320, 330, 350, 370, 390, 410, 430, 440, 460, 480, 500, 520],
        latestYear: [1300, 1400, 1500, 1600, 1700, 1800, 1900, 2000, 2200, 2300, 2400, 2500],
    },
    FishSoup: {
        latest7Days: [80, 90, 100, 110, 120, 130, 140],
        latestMonth: [280, 290, 300, 320, 330, 340, 350, 360, 370, 380, 400, 420],
        latestYear: [1100, 1200, 1300, 1400, 1500, 1600, 1700, 1800, 1900, 2000, 2100, 2200],
    },
    Steak: {
        latest7Days: [180, 200, 220, 230, 240, 250, 270],
        latestMonth: [450, 470, 490, 510, 530, 550, 570, 590, 610, 630, 650, 670],
        latestYear: [1800, 1900, 2000, 2100, 2300, 2400, 2500, 2700, 2800, 3000, 3200, 3400],
    },
    "Egg and bacon": {
        latest7Days: [90, 100, 110, 120, 130, 140, 150],
        latestMonth: [250, 260, 270, 290, 300, 320, 340, 350, 360, 380, 400, 420],
        latestYear: [1000, 1100, 1200, 1300, 1400, 1500, 1600, 1700, 1800, 1900, 2000, 2100],
    },
    Beer: {
        latest7Days: [110, 120, 130, 140, 150, 160, 170],
        latestMonth: [300, 310, 320, 330, 340, 360, 370, 380, 400, 420, 430, 440],
        latestYear: [1300, 1400, 1500, 1600, 1700, 1800, 1900, 2000, 2100, 2200, 2300, 2400],
    },
    "Red wine": {
        latest7Days: [120, 130, 140, 150, 160, 170, 180],
        latestMonth: [320, 330, 340, 350, 360, 370, 390, 400, 410, 430, 450, 460],
        latestYear: [1400, 1500, 1600, 1700, 1800, 1900, 2000, 2100, 2300, 2400, 2500, 2600],
    },
    Pancakes: {
        latest7Days: [70, 80, 90, 100, 110, 120, 130],
        latestMonth: [200, 220, 230, 240, 250, 260, 270, 280, 300, 310, 320, 330],
        latestYear: [800, 900, 1000, 1100, 1200, 1300, 1400, 1500, 1600, 1700, 1800, 1900],
    },
    Coffee: {
        latest7Days: [210, 220, 230, 240, 250, 260, 270],
        latestMonth: [550, 560, 570, 590, 600, 610, 620, 630, 650, 670, 680, 700],
        latestYear: [2000, 2100, 2200, 2300, 2400, 2500, 2600, 2700, 2800, 3000, 3100, 3200],
    },
    "Apple pie": {
        latest7Days: [50, 60, 100, 80, 90, 100, 110],
        latestMonth: [150, 160, 170, 180, 25, 200, 210, 220, 230, 240, 250, 260],
        latestYear: [600, 700, 800, 900, 2500, 1100, 1200, 1300, 1400, 1500, 1600, 1700],
    },
};
